...
TEST_CASES = {
    ...
    'Monday B': {
        'street_address': '10 Burke Road North, IVANHOE EAST'},
    'Thursday A': {
        'street_address': '255 St Helena Road, GREENSBOROUGH'},
    'Thursday B': {
        'street_address': '35 Para Road, MONTMORENCY'}}
